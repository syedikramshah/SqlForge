...
{
    /// <summary>
    /// Implements ISqlParser for MS SQL Server (T-SQL) dialect.
    /// </summary>
    public class MsSqlServerParser : BaseSqlParser
    {
        private readonly IStatementParserFactory _statementParserFactory;

        public MsSqlServerParser(IStatementParserFactory statementParserFactory)
        {
