...
namespace SqlForge.Parsers
{
    public class MsSqlServerStatementParserFactory : IStatementParserFactory
    {
        ...
        public MsSqlServerStatementParserFactory(MsSqlSelectStatementParser selectStatementParser, IExpressionParser expressionParser)
        {
        ...
        private CreateIndexStatement ParseCreateIndexStatement(IParserContext context)
        {
            ...
            if (context.IsKeyword("INCLUDE"))
            {
                context.ConsumeToken("INCLUDE");
                statement.IncludeColumns.AddRange(ParseConstraintColumns(context));
            }
